...
namespace NoMatterWebApi.Helpers
{
	public class ProductHelper
	{
		...
		//public static Product GenerateProductDbModel(Product product, int categoryId, IGeneralHelper generalHelper)
		//{
		...
		//public static Product UpdateProductDbModel(NoMatterDatabaseModel.Product productDb, Product product)
		//{
		...
		public static void DeleteProductPictures(Product product, IGeneralHelper generalHelper)
		{
