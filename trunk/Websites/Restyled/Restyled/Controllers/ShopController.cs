...
namespace RestyledLiving.Controllers
{
	public class ShopController : Controller
	{
		...
		public async Task<ActionResult> SectionShop(int sectionId)
		{
		...
		public async Task<ActionResult> CategoryShop(string categoryId)
		{
			...
			var categories = await SectionCategoriesSessionCache.GetSectionCategories(_sectionHelper, category.Section.SectionId);

			//TODO: move this to a cache
			//Get the section details from the cache
			//var section = await _sectionHelper.GetSectionAsync(category.SectionId);
			var section = ClientSectionsStaticCache.GetClientSection(category.Section.SectionId);
