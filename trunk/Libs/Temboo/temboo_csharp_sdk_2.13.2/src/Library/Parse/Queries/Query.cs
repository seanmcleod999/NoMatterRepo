...
namespace Temboo.Library.Parse.Queries
{
    /// <summary>
    /// Query
    ...
    public class Query : Temboo.Core.Choreography
    {
        ...
        public Query(TembooSession session) : base(session, "/Library/Parse/Queries/Query")
        {
        }
         ...
         /// <summary>
         /// (required, string) The class name for the object being queried.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) Limits the number of fields returned in the response to the fields names specificed in this comma-separated list. Special fields such as objectId, createdAt, and updatedAt will still be returned.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) Specifies a field to sort by. Prefixing with a negative sign reverses the order (e.g., -created_at).
         /// </summary>
