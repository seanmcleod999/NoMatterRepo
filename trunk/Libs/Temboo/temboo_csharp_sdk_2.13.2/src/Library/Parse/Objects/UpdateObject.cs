...
namespace Temboo.Library.Parse.Objects
{
    ...
    /// </summary>
    public class UpdateObject : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateObject Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateObject(TembooSession session) : base(session, "/Library/Parse/Objects/UpdateObject")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ObjectContents input for this Choreo.</param>
         public void setObjectContents(String value) {
             base.addInput ("ObjectContents", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A UpdateObjectResultSet containing execution metadata and results.</returns>
        new public UpdateObjectResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateObjectResultSet results = new JavaScriptSerializer().Deserialize<UpdateObjectResultSet>(json);
    ...
    /// </summary>
    public class UpdateObjectResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
