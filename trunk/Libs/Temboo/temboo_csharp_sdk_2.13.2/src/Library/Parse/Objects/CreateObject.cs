...
namespace Temboo.Library.Parse.Objects
{
    ...
    /// </summary>
    public class CreateObject : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateObject Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateObject(TembooSession session) : base(session, "/Library/Parse/Objects/CreateObject")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateObjectResultSet containing execution metadata and results.</returns>
        new public CreateObjectResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateObjectResultSet results = new JavaScriptSerializer().Deserialize<CreateObjectResultSet>(json);
    ...
    /// </summary>
    public class CreateObjectResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
