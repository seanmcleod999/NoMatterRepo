...
namespace Temboo.Library.Parse.PushNotifications
{
    ...
    /// </summary>
    public class UploadInstallationData : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UploadInstallationData Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UploadInstallationData(TembooSession session) : base(session, "/Library/Parse/PushNotifications/UploadInstallationData")
        {
        }
        ...
        /// </summary>
        /// <returns>A UploadInstallationDataResultSet containing execution metadata and results.</returns>
        new public UploadInstallationDataResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UploadInstallationDataResultSet results = new JavaScriptSerializer().Deserialize<UploadInstallationDataResultSet>(json);
    ...
    /// </summary>
    public class UploadInstallationDataResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
