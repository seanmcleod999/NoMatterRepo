...
namespace Temboo.Library.Parse.PushNotifications
{
    ...
    /// </summary>
    public class RetrieveInstallation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveInstallation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveInstallation(TembooSession session) : base(session, "/Library/Parse/PushNotifications/RetrieveInstallation")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveInstallationResultSet containing execution metadata and results.</returns>
        new public RetrieveInstallationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveInstallationResultSet results = new JavaScriptSerializer().Deserialize<RetrieveInstallationResultSet>(json);
    ...
    /// </summary>
    public class RetrieveInstallationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
