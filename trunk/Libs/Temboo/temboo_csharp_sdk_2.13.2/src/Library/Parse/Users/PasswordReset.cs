...
namespace Temboo.Library.Parse.Users
{
    ...
    public class PasswordReset : Temboo.Core.Choreography
    {
        ...
        public PasswordReset(TembooSession session) : base(session, "/Library/Parse/Users/PasswordReset")
        {
        }

         /// <summary>
         /// (required, string) The email address for the user who wishes to reset their password.
         /// </summary>
