...
namespace Temboo.Library.Parse.Users
{
    ...
    public class UpdateUser : Temboo.Core.Choreography
    {
        ...
        public UpdateUser(TembooSession session) : base(session, "/Library/Parse/Users/UpdateUser")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the UserInformation input for this Choreo.</param>
         public void setUserInformation(String value) {
             base.addInput ("UserInformation", value);
         }
         /// <summary>
