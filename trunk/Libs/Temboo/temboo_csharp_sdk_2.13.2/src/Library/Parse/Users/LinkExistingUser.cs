...
namespace Temboo.Library.Parse.Users
{
    ...
    /// </summary>
    public class LinkExistingUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LinkExistingUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LinkExistingUser(TembooSession session) : base(session, "/Library/Parse/Users/LinkExistingUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A LinkExistingUserResultSet containing execution metadata and results.</returns>
        new public LinkExistingUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LinkExistingUserResultSet results = new JavaScriptSerializer().Deserialize<LinkExistingUserResultSet>(json);
    ...
    /// </summary>
    public class LinkExistingUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
