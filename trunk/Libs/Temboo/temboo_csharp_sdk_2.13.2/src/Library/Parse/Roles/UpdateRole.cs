...
namespace Temboo.Library.Parse.Roles
{
    ...
    /// </summary>
    public class UpdateRole : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the UpdateRole Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public UpdateRole(TembooSession session) : base(session, "/Library/Parse/Roles/UpdateRole")
        {
        }
        ...
        /// </summary>
        /// <returns>A UpdateRoleResultSet containing execution metadata and results.</returns>
        new public UpdateRoleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            UpdateRoleResultSet results = new JavaScriptSerializer().Deserialize<UpdateRoleResultSet>(json);
    ...
    /// </summary>
    public class UpdateRoleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
