...
namespace Temboo.Library.Parse.Roles
{
    ...
    /// </summary>
    public class RetrieveRole : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveRole Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveRole(TembooSession session) : base(session, "/Library/Parse/Roles/RetrieveRole")
        {
        }

         /// <summary>
         /// (required, string) The ID of the role to be retrieved.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A RetrieveRoleResultSet containing execution metadata and results.</returns>
        new public RetrieveRoleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveRoleResultSet results = new JavaScriptSerializer().Deserialize<RetrieveRoleResultSet>(json);
    ...
    /// </summary>
    public class RetrieveRoleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
