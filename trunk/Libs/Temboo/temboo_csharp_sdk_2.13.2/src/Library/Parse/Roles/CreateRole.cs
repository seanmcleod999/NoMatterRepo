...
namespace Temboo.Library.Parse.Roles
{
    ...
    /// Creates a new role.
    /// </summary>
    public class CreateRole : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreateRole Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreateRole(TembooSession session) : base(session, "/Library/Parse/Roles/CreateRole")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreateRoleResultSet containing execution metadata and results.</returns>
        new public CreateRoleResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreateRoleResultSet results = new JavaScriptSerializer().Deserialize<CreateRoleResultSet>(json);
    ...
    /// </summary>
    public class CreateRoleResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
