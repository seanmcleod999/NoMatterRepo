...
namespace Temboo.Library.Tumblr.Post
{
    ...
    /// </summary>
    public class EditTextPost : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the EditTextPost Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public EditTextPost(TembooSession session) : base(session, "/Library/Tumblr/Post/EditTextPost")
        {
        }
        ...
        /// </summary>
        /// <returns>A EditTextPostResultSet containing execution metadata and results.</returns>
        new public EditTextPostResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            EditTextPostResultSet results = new JavaScriptSerializer().Deserialize<EditTextPostResultSet>(json);
    ...
    /// </summary>
    public class EditTextPostResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
