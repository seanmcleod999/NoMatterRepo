...
namespace Temboo.Library.Tumblr.User
{
    ...
    /// </summary>
    public class GetUserInformation : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUserInformation Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUserInformation(TembooSession session) : base(session, "/Library/Tumblr/User/GetUserInformation")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUserInformationResultSet containing execution metadata and results.</returns>
        new public GetUserInformationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUserInformationResultSet results = new JavaScriptSerializer().Deserialize<GetUserInformationResultSet>(json);
    ...
    /// </summary>
    public class GetUserInformationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
