...
namespace Temboo.Library.Dropbox.Datastore
{
    ...
    /// </summary>
    public class GetOrCreateDatastore : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetOrCreateDatastore Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetOrCreateDatastore(TembooSession session) : base(session, "/Library/Dropbox/Datastore/GetOrCreateDatastore")
        {
        }
         ...
         /// <summary>
         /// (required, string) The private ID for a datastore to create or to verify.
         /// </summary>
         /// <param name="value">Value of the DatastoreID input for this Choreo.</param>
         public void setDatastoreID(String value) {
             base.addInput ("DatastoreID", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A GetOrCreateDatastoreResultSet containing execution metadata and results.</returns>
        new public GetOrCreateDatastoreResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetOrCreateDatastoreResultSet results = new JavaScriptSerializer().Deserialize<GetOrCreateDatastoreResultSet>(json);
    ...
    /// </summary>
    public class GetOrCreateDatastoreResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
