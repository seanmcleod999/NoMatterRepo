...
namespace Temboo.Library.Dropbox.Datastore
{
    ...
    /// </summary>
    public class ListDatastores : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListDatastores Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListDatastores(TembooSession session) : base(session, "/Library/Dropbox/Datastore/ListDatastores")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListDatastoresResultSet containing execution metadata and results.</returns>
        new public ListDatastoresResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListDatastoresResultSet results = new JavaScriptSerializer().Deserialize<ListDatastoresResultSet>(json);
    ...
    /// </summary>
    public class ListDatastoresResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
