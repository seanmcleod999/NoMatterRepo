...
namespace Temboo.Library.Dropbox.Datastore
{
    ...
    /// </summary>
    public class DeleteDatastore : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteDatastore Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteDatastore(TembooSession session) : base(session, "/Library/Dropbox/Datastore/DeleteDatastore")
        {
        }
         ...
         /// <summary>
         /// (required, string) The handle of an existing datastore to delete.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A DeleteDatastoreResultSet containing execution metadata and results.</returns>
        new public DeleteDatastoreResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteDatastoreResultSet results = new JavaScriptSerializer().Deserialize<DeleteDatastoreResultSet>(json);
    ...
    /// </summary>
    public class DeleteDatastoreResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
