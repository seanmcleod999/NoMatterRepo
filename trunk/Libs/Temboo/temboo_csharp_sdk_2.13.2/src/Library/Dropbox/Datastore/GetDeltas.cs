...
namespace Temboo.Library.Dropbox.Datastore
{
    ...
    /// </summary>
    public class GetDeltas : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetDeltas Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetDeltas(TembooSession session) : base(session, "/Library/Dropbox/Datastore/GetDeltas")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetDeltasResultSet containing execution metadata and results.</returns>
        new public GetDeltasResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetDeltasResultSet results = new JavaScriptSerializer().Deserialize<GetDeltasResultSet>(json);
    ...
    /// </summary>
    public class GetDeltasResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
