...
namespace Temboo.Library.Dropbox.FileOperations
{
    ...
    /// </summary>
    public class CopyFileOrFolder : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CopyFileOrFolder Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CopyFileOrFolder(TembooSession session) : base(session, "/Library/Dropbox/FileOperations/CopyFileOrFolder")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the FromCopyRef input for this Choreo.</param>
         public void setFromCopyRef(String value) {
             base.addInput ("FromCopyRef", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A CopyFileOrFolderResultSet containing execution metadata and results.</returns>
        new public CopyFileOrFolderResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CopyFileOrFolderResultSet results = new JavaScriptSerializer().Deserialize<CopyFileOrFolderResultSet>(json);
    ...
    /// </summary>
    public class CopyFileOrFolderResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
