...
namespace Temboo.Library.Twitter.Help
{
    /// <summary>
    /// GetRateLimitStatus
    ...
    /// </summary>
    public class GetRateLimitStatus : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetRateLimitStatus Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetRateLimitStatus(TembooSession session) : base(session, "/Library/Twitter/Help/GetRateLimitStatus")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the Resources input for this Choreo.</param>
         public void setResources(String value) {
             base.addInput ("Resources", value);
         }
        ...
        /// </summary>
        /// <returns>A GetRateLimitStatusResultSet containing execution metadata and results.</returns>
        new public GetRateLimitStatusResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetRateLimitStatusResultSet results = new JavaScriptSerializer().Deserialize<GetRateLimitStatusResultSet>(json);
    ...
    /// </summary>
    public class GetRateLimitStatusResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
