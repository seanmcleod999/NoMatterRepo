...
namespace Temboo.Library.Twitter.DirectMessages
{
    ...
    /// </summary>
    public class DirectMessagesSent : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DirectMessagesSent Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DirectMessagesSent(TembooSession session) : base(session, "/Library/Twitter/DirectMessages/DirectMessagesSent")
        {
        }
        ...
        /// </summary>
        /// <returns>A DirectMessagesSentResultSet containing execution metadata and results.</returns>
        new public DirectMessagesSentResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DirectMessagesSentResultSet results = new JavaScriptSerializer().Deserialize<DirectMessagesSentResultSet>(json);
    ...
    /// </summary>
    public class DirectMessagesSentResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
