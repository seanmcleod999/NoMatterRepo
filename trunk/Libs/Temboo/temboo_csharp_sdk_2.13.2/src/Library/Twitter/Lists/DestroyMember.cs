...
namespace Temboo.Library.Twitter.Lists
{
    ...
    /// </summary>
    public class DestroyMember : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DestroyMember Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DestroyMember(TembooSession session) : base(session, "/Library/Twitter/Lists/DestroyMember")
        {
        }
        ...
        /// </summary>
        /// <returns>A DestroyMemberResultSet containing execution metadata and results.</returns>
        new public DestroyMemberResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DestroyMemberResultSet results = new JavaScriptSerializer().Deserialize<DestroyMemberResultSet>(json);
    ...
    /// </summary>
    public class DestroyMemberResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
