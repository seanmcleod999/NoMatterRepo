...
namespace Temboo.Library.Google.Picasa
{
    ...
    /// </summary>
    public class RetrieveTagsByUser : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveTagsByUser Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveTagsByUser(TembooSession session) : base(session, "/Library/Google/Picasa/RetrieveTagsByUser")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveTagsByUserResultSet containing execution metadata and results.</returns>
        new public RetrieveTagsByUserResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveTagsByUserResultSet results = new JavaScriptSerializer().Deserialize<RetrieveTagsByUserResultSet>(json);
    ...
    /// </summary>
    public class RetrieveTagsByUserResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
