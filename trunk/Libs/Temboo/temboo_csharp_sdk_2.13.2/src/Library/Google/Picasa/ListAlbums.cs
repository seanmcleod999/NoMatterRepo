...
namespace Temboo.Library.Google.Picasa
{
    ...
    /// </summary>
    public class ListAlbums : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAlbums Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAlbums(TembooSession session) : base(session, "/Library/Google/Picasa/ListAlbums")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAlbumsResultSet containing execution metadata and results.</returns>
        new public ListAlbumsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAlbumsResultSet results = new JavaScriptSerializer().Deserialize<ListAlbumsResultSet>(json);
    ...
    /// </summary>
    public class ListAlbumsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
