...
namespace Temboo.Library.Google.Picasa
{
    ...
    /// </summary>
    public class RetrieveComments : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveComments Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveComments(TembooSession session) : base(session, "/Library/Google/Picasa/RetrieveComments")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveCommentsResultSet containing execution metadata and results.</returns>
        new public RetrieveCommentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveCommentsResultSet results = new JavaScriptSerializer().Deserialize<RetrieveCommentsResultSet>(json);
    ...
    /// </summary>
    public class RetrieveCommentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
