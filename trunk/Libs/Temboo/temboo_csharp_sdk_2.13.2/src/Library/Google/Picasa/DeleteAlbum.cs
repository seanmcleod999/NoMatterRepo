...
namespace Temboo.Library.Google.Picasa
{
    ...
    /// </summary>
    public class DeleteAlbum : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteAlbum Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteAlbum(TembooSession session) : base(session, "/Library/Google/Picasa/DeleteAlbum")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteAlbumResultSet containing execution metadata and results.</returns>
        new public DeleteAlbumResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteAlbumResultSet results = new JavaScriptSerializer().Deserialize<DeleteAlbumResultSet>(json);
    ...
    /// </summary>
    public class DeleteAlbumResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
