...
namespace Temboo.Library.Google.Picasa
{
    ...
    /// </summary>
    public class SearchPhotosByTag : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the SearchPhotosByTag Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public SearchPhotosByTag(TembooSession session) : base(session, "/Library/Google/Picasa/SearchPhotosByTag")
        {
        }
        ...
        /// </summary>
        /// <returns>A SearchPhotosByTagResultSet containing execution metadata and results.</returns>
        new public SearchPhotosByTagResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            SearchPhotosByTagResultSet results = new JavaScriptSerializer().Deserialize<SearchPhotosByTagResultSet>(json);
    ...
    /// </summary>
    public class SearchPhotosByTagResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
