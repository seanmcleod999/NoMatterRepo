...
namespace Temboo.Library.Google.Picasa
{
    ...
    /// </summary>
    public class ListPhotosByAlbum : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListPhotosByAlbum Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListPhotosByAlbum(TembooSession session) : base(session, "/Library/Google/Picasa/ListPhotosByAlbum")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListPhotosByAlbumResultSet containing execution metadata and results.</returns>
        new public ListPhotosByAlbumResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListPhotosByAlbumResultSet results = new JavaScriptSerializer().Deserialize<ListPhotosByAlbumResultSet>(json);
    ...
    /// </summary>
    public class ListPhotosByAlbumResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
