...
namespace Temboo.Library.Google.Picasa
{
    ...
    /// </summary>
    public class PostPhoto : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PostPhoto Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PostPhoto(TembooSession session) : base(session, "/Library/Google/Picasa/PostPhoto")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ImageName input for this Choreo.</param>
         public void setImageName(String value) {
             base.addInput ("ImageName", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A PostPhotoResultSet containing execution metadata and results.</returns>
        new public PostPhotoResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PostPhotoResultSet results = new JavaScriptSerializer().Deserialize<PostPhotoResultSet>(json);
    ...
    /// </summary>
    public class PostPhotoResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
