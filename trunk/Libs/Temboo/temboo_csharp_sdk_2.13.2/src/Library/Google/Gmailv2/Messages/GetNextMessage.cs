...
namespace Temboo.Library.Google.Gmailv2.Messages
{
    ...
    /// </summary>
    public class GetNextMessage : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetNextMessage Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetNextMessage(TembooSession session) : base(session, "/Library/Google/Gmailv2/Messages/GetNextMessage")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetNextMessageResultSet containing execution metadata and results.</returns>
        new public GetNextMessageResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetNextMessageResultSet results = new JavaScriptSerializer().Deserialize<GetNextMessageResultSet>(json);
    ...
    /// </summary>
    public class GetNextMessageResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
        ...
        /// <returns>String - (integer) The response code returned from Google. A 200 is expected for a successful request. A 404 indicates that the stored history id has become invalid or expired. See Choreo notes for more details.</returns>
        /// </summary>
