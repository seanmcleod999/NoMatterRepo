...
namespace Temboo.Library.Fitbit.OAuth
{
    ...
    public class InitializeOAuth : Temboo.Core.Choreography
    {
        ...
        public InitializeOAuth(TembooSession session) : base(session, "/Library/Fitbit/OAuth/InitializeOAuth")
        {
         ...
         /// <summary>
         /// (optional, string) A unique identifier that you can pass to eliminate the need to wait for a Temboo-generated CallbackID. Callback identifiers may only contain numbers, letters, periods, and hyphens. (OAuth 2.0 only)
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) A space-delimited list of the permissions you are requesting (required when using OAuth 2.0). See Choreo notes for a list of valid values for this input.
         /// </summary>
    ...
    public class InitializeOAuthResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (string) The temporary OAuth 1.0 Token Secret that can be exchanged for permanent tokens using the FinalizeOAuth Choreo.</returns>
        /// </summary>
