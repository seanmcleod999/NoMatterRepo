...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Inbox : Temboo.Core.Choreography
    {
        ...
        public Inbox(TembooSession session) : base(session, "/Library/Facebook/Reading/Inbox")
        {
        }
        ...
        /// </summary>
        /// <returns>A InboxResultSet containing execution metadata and results.</returns>
        new public InboxResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            InboxResultSet results = new JavaScriptSerializer().Deserialize<InboxResultSet>(json);
    ...
    /// </summary>
    public class InboxResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
