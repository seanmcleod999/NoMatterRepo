...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class GetUnreadMessages : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUnreadMessages Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUnreadMessages(TembooSession session) : base(session, "/Library/Facebook/Reading/GetUnreadMessages")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetUnreadMessagesResultSet containing execution metadata and results.</returns>
        new public GetUnreadMessagesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUnreadMessagesResultSet results = new JavaScriptSerializer().Deserialize<GetUnreadMessagesResultSet>(json);
    ...
    /// </summary>
    public class GetUnreadMessagesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
