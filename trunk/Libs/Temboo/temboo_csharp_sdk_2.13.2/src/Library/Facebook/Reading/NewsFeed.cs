...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class NewsFeed : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the NewsFeed Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public NewsFeed(TembooSession session) : base(session, "/Library/Facebook/Reading/NewsFeed")
        {
        }
        ...
        /// </summary>
        /// <returns>A NewsFeedResultSet containing execution metadata and results.</returns>
        new public NewsFeedResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            NewsFeedResultSet results = new JavaScriptSerializer().Deserialize<NewsFeedResultSet>(json);
    ...
    /// </summary>
    public class NewsFeedResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
