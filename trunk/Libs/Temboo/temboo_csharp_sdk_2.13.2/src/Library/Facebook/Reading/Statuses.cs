...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Statuses : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Statuses Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Statuses(TembooSession session) : base(session, "/Library/Facebook/Reading/Statuses")
        {
        }
        ...
        /// </summary>
        /// <returns>A StatusesResultSet containing execution metadata and results.</returns>
        new public StatusesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            StatusesResultSet results = new JavaScriptSerializer().Deserialize<StatusesResultSet>(json);
    ...
    /// </summary>
    public class StatusesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
