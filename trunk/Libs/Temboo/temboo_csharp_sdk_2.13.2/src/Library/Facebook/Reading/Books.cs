...
namespace Temboo.Library.Facebook.Reading
{
    ...
    /// </summary>
    public class Books : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the Books Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public Books(TembooSession session) : base(session, "/Library/Facebook/Reading/Books")
        {
        }
         ...
         /// <summary>
         /// (optional, string) The id of the user to retrieve books for. Defaults to "me" indicating the authenticated user.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A BooksResultSet containing execution metadata and results.</returns>
        new public BooksResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            BooksResultSet results = new JavaScriptSerializer().Deserialize<BooksResultSet>(json);
    ...
    /// </summary>
    public class BooksResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
