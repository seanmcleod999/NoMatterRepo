...
namespace Temboo.Library.Facebook.Actions.News.Publishes
{
    ...
    /// </summary>
    public class CreatePublication : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the CreatePublication Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public CreatePublication(TembooSession session) : base(session, "/Library/Facebook/Actions/News/Publishes/CreatePublication")
        {
        }
        ...
        /// </summary>
        /// <returns>A CreatePublicationResultSet containing execution metadata and results.</returns>
        new public CreatePublicationResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            CreatePublicationResultSet results = new JavaScriptSerializer().Deserialize<CreatePublicationResultSet>(json);
    ...
    /// </summary>
    public class CreatePublicationResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
