...
namespace Temboo.Library.Zendesk.Views
{
    ...
    /// </summary>
    public class ListViews : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListViews Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListViews(TembooSession session) : base(session, "/Library/Zendesk/Views/ListViews")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListViewsResultSet containing execution metadata and results.</returns>
        new public ListViewsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListViewsResultSet results = new JavaScriptSerializer().Deserialize<ListViewsResultSet>(json);
    ...
    /// </summary>
    public class ListViewsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
