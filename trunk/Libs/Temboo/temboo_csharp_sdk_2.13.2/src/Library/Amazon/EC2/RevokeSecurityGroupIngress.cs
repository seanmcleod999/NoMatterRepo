...
namespace Temboo.Library.Amazon.EC2
{
    ...
    /// </summary>
    public class RevokeSecurityGroupIngress : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RevokeSecurityGroupIngress Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RevokeSecurityGroupIngress(TembooSession session) : base(session, "/Library/Amazon/EC2/RevokeSecurityGroupIngress")
        {
        }
        ...
        /// </summary>
        /// <returns>A RevokeSecurityGroupIngressResultSet containing execution metadata and results.</returns>
        new public RevokeSecurityGroupIngressResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RevokeSecurityGroupIngressResultSet results = new JavaScriptSerializer().Deserialize<RevokeSecurityGroupIngressResultSet>(json);
    ...
    /// </summary>
    public class RevokeSecurityGroupIngressResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
