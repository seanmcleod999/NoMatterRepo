...
namespace Temboo.Library.Amazon.CloudDrive.Trash
{
    ...
    /// </summary>
    public class ListTrash : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTrash Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTrash(TembooSession session) : base(session, "/Library/Amazon/CloudDrive/Trash/ListTrash")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTrashResultSet containing execution metadata and results.</returns>
        new public ListTrashResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTrashResultSet results = new JavaScriptSerializer().Deserialize<ListTrashResultSet>(json);
    ...
    /// </summary>
    public class ListTrashResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
