...
namespace Temboo.Library.Flickr.Photos
{
    ...
    /// </summary>
    public class ListGeoTaggedPhotos : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListGeoTaggedPhotos Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListGeoTaggedPhotos(TembooSession session) : base(session, "/Library/Flickr/Photos/ListGeoTaggedPhotos")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListGeoTaggedPhotosResultSet containing execution metadata and results.</returns>
        new public ListGeoTaggedPhotosResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListGeoTaggedPhotosResultSet results = new JavaScriptSerializer().Deserialize<ListGeoTaggedPhotosResultSet>(json);
    ...
    /// </summary>
    public class ListGeoTaggedPhotosResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
