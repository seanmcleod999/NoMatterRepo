...
namespace Temboo.Library.Microsoft.Translator
{
    ...
    /// </summary>
    public class GetLanguagesForTranslate : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetLanguagesForTranslate Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetLanguagesForTranslate(TembooSession session) : base(session, "/Library/Microsoft/Translator/GetLanguagesForTranslate")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetLanguagesForTranslateResultSet containing execution metadata and results.</returns>
        new public GetLanguagesForTranslateResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetLanguagesForTranslateResultSet results = new JavaScriptSerializer().Deserialize<GetLanguagesForTranslateResultSet>(json);
    ...
    /// </summary>
    public class GetLanguagesForTranslateResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
