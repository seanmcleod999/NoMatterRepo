...
namespace Temboo.Library.Microsoft.Translator
{
    ...
    /// </summary>
    public class TranslateArray : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TranslateArray Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TranslateArray(TembooSession session) : base(session, "/Library/Microsoft/Translator/TranslateArray")
        {
        }
        ...
        /// </summary>
        /// <returns>A TranslateArrayResultSet containing execution metadata and results.</returns>
        new public TranslateArrayResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TranslateArrayResultSet results = new JavaScriptSerializer().Deserialize<TranslateArrayResultSet>(json);
    ...
    /// </summary>
    public class TranslateArrayResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
