...
namespace Temboo.Library.FilesAnywhere
{
    ...
    public class UploadFile : Temboo.Core.Choreography
    {
        ...
        public UploadFile(TembooSession session) : base(session, "/Library/FilesAnywhere/UploadFile")
        {
        }
         ...
         /// <summary>
         /// (conditional, string) The base64 encoded file contents of the file you want to upload.
         /// </summary>
