...
namespace Temboo.Library.YouTube.Subscriptions
{
    ...
    /// </summary>
    public class ListSubscriptionsByChannel : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListSubscriptionsByChannel Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListSubscriptionsByChannel(TembooSession session) : base(session, "/Library/YouTube/Subscriptions/ListSubscriptionsByChannel")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListSubscriptionsByChannelResultSet containing execution metadata and results.</returns>
        new public ListSubscriptionsByChannelResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListSubscriptionsByChannelResultSet results = new JavaScriptSerializer().Deserialize<ListSubscriptionsByChannelResultSet>(json);
    ...
    /// </summary>
    public class ListSubscriptionsByChannelResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
