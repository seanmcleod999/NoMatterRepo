...
namespace Temboo.Library.YouTube.Subscriptions
{
    ...
    /// </summary>
    public class DeleteSubscription : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the DeleteSubscription Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public DeleteSubscription(TembooSession session) : base(session, "/Library/YouTube/Subscriptions/DeleteSubscription")
        {
        }
        ...
        /// </summary>
        /// <returns>A DeleteSubscriptionResultSet containing execution metadata and results.</returns>
        new public DeleteSubscriptionResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            DeleteSubscriptionResultSet results = new JavaScriptSerializer().Deserialize<DeleteSubscriptionResultSet>(json);
    ...
    /// </summary>
    public class DeleteSubscriptionResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
