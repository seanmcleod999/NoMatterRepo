...
namespace Temboo.Library.Twilio.SMSMessages
{
    ...
    public class GetLastMessageThatContainsResultSet : Temboo.Core.ResultSet
    {
        ...
        /// <returns>String - (integer) The total number of result pages that are available to search. If your search returns no results, you can increment the Page input to search further into the list of messages.</returns>
        /// </summary>
