...
namespace Temboo.Library.Bugzilla
{
    ...
    /// </summary>
    public class RetrieveBug : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveBug Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveBug(TembooSession session) : base(session, "/Library/Bugzilla/RetrieveBug")
        {
        }

         /// <summary>
         /// (required, integer) The ID of the bug to retrieve information for.
         /// </summary>
         /// <param name="value">Value of the BugID input for this Choreo.</param>
         public void setBugID(String value) {
             base.addInput ("BugID", value);
         }
         /// <summary>
         ...
         /// </summary>
         /// <param name="value">Value of the IncludeFields input for this Choreo.</param>
         public void setIncludeFields(String value) {
             base.addInput ("IncludeFields", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A RetrieveBugResultSet containing execution metadata and results.</returns>
        new public RetrieveBugResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveBugResultSet results = new JavaScriptSerializer().Deserialize<RetrieveBugResultSet>(json);
    ...
    /// </summary>
    public class RetrieveBugResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
