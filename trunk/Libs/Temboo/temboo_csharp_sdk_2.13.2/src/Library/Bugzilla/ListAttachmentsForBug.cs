...
namespace Temboo.Library.Bugzilla
{
    ...
    /// </summary>
    public class ListAttachmentsForBug : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAttachmentsForBug Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAttachmentsForBug(TembooSession session) : base(session, "/Library/Bugzilla/ListAttachmentsForBug")
        {
        }
         ...
         /// <summary>
         /// (required, integer) The ID for the bug to list attachments for.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A ListAttachmentsForBugResultSet containing execution metadata and results.</returns>
        new public ListAttachmentsForBugResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAttachmentsForBugResultSet results = new JavaScriptSerializer().Deserialize<ListAttachmentsForBugResultSet>(json);
    ...
    /// </summary>
    public class ListAttachmentsForBugResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
