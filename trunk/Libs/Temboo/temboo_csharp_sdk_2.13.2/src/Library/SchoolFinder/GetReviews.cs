...
namespace Temboo.Library.SchoolFinder
{
    ...
    /// </summary>
    public class GetReviews : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetReviews Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetReviews(TembooSession session) : base(session, "/Library/SchoolFinder/GetReviews")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetReviewsResultSet containing execution metadata and results.</returns>
        new public GetReviewsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetReviewsResultSet results = new JavaScriptSerializer().Deserialize<GetReviewsResultSet>(json);
    ...
    /// </summary>
    public class GetReviewsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
