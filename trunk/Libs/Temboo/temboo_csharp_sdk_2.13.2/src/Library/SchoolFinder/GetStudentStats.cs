...
namespace Temboo.Library.SchoolFinder
{
    ...
    /// </summary>
    public class GetStudentStats : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetStudentStats Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetStudentStats(TembooSession session) : base(session, "/Library/SchoolFinder/GetStudentStats")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetStudentStatsResultSet containing execution metadata and results.</returns>
        new public GetStudentStatsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetStudentStatsResultSet results = new JavaScriptSerializer().Deserialize<GetStudentStatsResultSet>(json);
    ...
    /// </summary>
    public class GetStudentStatsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
