...
namespace Temboo.Library.SchoolFinder
{
    ...
    /// </summary>
    public class NumberOf : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the NumberOf Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public NumberOf(TembooSession session) : base(session, "/Library/SchoolFinder/NumberOf")
        {
        }
        ...
        /// </summary>
        /// <returns>A NumberOfResultSet containing execution metadata and results.</returns>
        new public NumberOfResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            NumberOfResultSet results = new JavaScriptSerializer().Deserialize<NumberOfResultSet>(json);
    ...
    /// </summary>
    public class NumberOfResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
