...
namespace Temboo.Library.SchoolFinder
{
    ...
    /// </summary>
    public class GetTestScores : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTestScores Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTestScores(TembooSession session) : base(session, "/Library/SchoolFinder/GetTestScores")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTestScoresResultSet containing execution metadata and results.</returns>
        new public GetTestScoresResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTestScoresResultSet results = new JavaScriptSerializer().Deserialize<GetTestScoresResultSet>(json);
    ...
    /// </summary>
    public class GetTestScoresResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
