...
namespace Temboo.Library.SchoolFinder
{
    ...
    /// </summary>
    public class GetTestRating : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetTestRating Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetTestRating(TembooSession session) : base(session, "/Library/SchoolFinder/GetTestRating")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetTestRatingResultSet containing execution metadata and results.</returns>
        new public GetTestRatingResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetTestRatingResultSet results = new JavaScriptSerializer().Deserialize<GetTestRatingResultSet>(json);
    ...
    /// </summary>
    public class GetTestRatingResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
