...
namespace Temboo.Library.InfluenceExplorer
{
    ...
    /// </summary>
    public class PartyBreakdown : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the PartyBreakdown Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public PartyBreakdown(TembooSession session) : base(session, "/Library/InfluenceExplorer/PartyBreakdown")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the ContributorType input for this Choreo.</param>
         public void setContributorType(String value) {
             base.addInput ("ContributorType", value);
         }
         /// <summary>
        ...
        /// </summary>
        /// <returns>A PartyBreakdownResultSet containing execution metadata and results.</returns>
        new public PartyBreakdownResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            PartyBreakdownResultSet results = new JavaScriptSerializer().Deserialize<PartyBreakdownResultSet>(json);
    ...
    /// </summary>
    public class PartyBreakdownResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
