...
namespace Temboo.Library.InfluenceExplorer
{
    ...
    /// </summary>
    public class LocalBreakdown : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the LocalBreakdown Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public LocalBreakdown(TembooSession session) : base(session, "/Library/InfluenceExplorer/LocalBreakdown")
        {
        }
        ...
        /// </summary>
        /// <returns>A LocalBreakdownResultSet containing execution metadata and results.</returns>
        new public LocalBreakdownResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            LocalBreakdownResultSet results = new JavaScriptSerializer().Deserialize<LocalBreakdownResultSet>(json);
    ...
    /// </summary>
    public class LocalBreakdownResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
