...
namespace Temboo.Library.InfluenceExplorer
{
    ...
    /// </summary>
    public class TopRecipientPoliticians : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TopRecipientPoliticians Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TopRecipientPoliticians(TembooSession session) : base(session, "/Library/InfluenceExplorer/TopRecipientPoliticians")
        {
        }
        ...
        /// </summary>
        /// <returns>A TopRecipientPoliticiansResultSet containing execution metadata and results.</returns>
        new public TopRecipientPoliticiansResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TopRecipientPoliticiansResultSet results = new JavaScriptSerializer().Deserialize<TopRecipientPoliticiansResultSet>(json);
    ...
    /// </summary>
    public class TopRecipientPoliticiansResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
