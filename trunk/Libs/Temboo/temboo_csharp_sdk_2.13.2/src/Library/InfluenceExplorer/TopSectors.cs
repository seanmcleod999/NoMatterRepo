...
namespace Temboo.Library.InfluenceExplorer
{
    ...
    /// </summary>
    public class TopSectors : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the TopSectors Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public TopSectors(TembooSession session) : base(session, "/Library/InfluenceExplorer/TopSectors")
        {
        }
        ...
        /// </summary>
        /// <returns>A TopSectorsResultSet containing execution metadata and results.</returns>
        new public TopSectorsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            TopSectorsResultSet results = new JavaScriptSerializer().Deserialize<TopSectorsResultSet>(json);
    ...
    /// </summary>
    public class TopSectorsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
