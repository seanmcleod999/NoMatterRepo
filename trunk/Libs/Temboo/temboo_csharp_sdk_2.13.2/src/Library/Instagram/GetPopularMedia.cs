...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class GetPopularMedia : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetPopularMedia Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetPopularMedia(TembooSession session) : base(session, "/Library/Instagram/GetPopularMedia")
        {
        }
        ...
        /// </summary>
        /// <returns>A GetPopularMediaResultSet containing execution metadata and results.</returns>
        new public GetPopularMediaResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetPopularMediaResultSet results = new JavaScriptSerializer().Deserialize<GetPopularMediaResultSet>(json);
    ...
    /// </summary>
    public class GetPopularMediaResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
