...
namespace Temboo.Library.Instagram.OAuth
{
    ...
    public class InitializeOAuth : Temboo.Core.Choreography
    {
        ...
        public InitializeOAuth(TembooSession session) : base(session, "/Library/Instagram/OAuth/InitializeOAuth")
        {
         ...
         /// <summary>
         /// (optional, string) The scope of the access you're requesting from the user. Valid values are: basic, comments, relationships, and likes. Multiple scope values should separated by spaces.
         /// </summary>
