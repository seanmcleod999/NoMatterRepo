...
namespace Temboo.Library.Instagram
{
    ...
    /// </summary>
    public class GetUserFeed : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the GetUserFeed Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public GetUserFeed(TembooSession session) : base(session, "/Library/Instagram/GetUserFeed")
        {
        }
         ...
         /// <summary>
         /// (optional, string) Returns media earlier than this max_id.
         /// </summary>
         ...
         /// <summary>
         /// (optional, string) The ID of the user whose feed to retrieve. Defaults to 'self' indicating that the authenticating user is assumed.
         /// </summary>
        ...
        /// </summary>
        /// <returns>A GetUserFeedResultSet containing execution metadata and results.</returns>
        new public GetUserFeedResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            GetUserFeedResultSet results = new JavaScriptSerializer().Deserialize<GetUserFeedResultSet>(json);
    ...
    /// </summary>
    public class GetUserFeedResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
