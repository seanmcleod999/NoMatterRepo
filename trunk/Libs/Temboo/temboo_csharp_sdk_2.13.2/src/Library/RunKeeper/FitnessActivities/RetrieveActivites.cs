...
namespace Temboo.Library.RunKeeper.FitnessActivities
{
    ...
    /// </summary>
    public class RetrieveActivites : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the RetrieveActivites Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public RetrieveActivites(TembooSession session) : base(session, "/Library/RunKeeper/FitnessActivities/RetrieveActivites")
        {
        }
        ...
        /// </summary>
        /// <returns>A RetrieveActivitesResultSet containing execution metadata and results.</returns>
        new public RetrieveActivitesResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            RetrieveActivitesResultSet results = new JavaScriptSerializer().Deserialize<RetrieveActivitesResultSet>(json);
    ...
    /// </summary>
    public class RetrieveActivitesResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
