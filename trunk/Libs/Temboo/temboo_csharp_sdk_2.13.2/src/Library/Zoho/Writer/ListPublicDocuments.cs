...
namespace Temboo.Library.Zoho.Writer
{
    ...
    /// </summary>
    public class ListPublicDocuments : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListPublicDocuments Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListPublicDocuments(TembooSession session) : base(session, "/Library/Zoho/Writer/ListPublicDocuments")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListPublicDocumentsResultSet containing execution metadata and results.</returns>
        new public ListPublicDocumentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListPublicDocumentsResultSet results = new JavaScriptSerializer().Deserialize<ListPublicDocumentsResultSet>(json);
    ...
    /// </summary>
    public class ListPublicDocumentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
