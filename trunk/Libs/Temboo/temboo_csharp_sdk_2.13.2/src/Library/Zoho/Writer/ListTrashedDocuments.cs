...
namespace Temboo.Library.Zoho.Writer
{
    ...
    /// </summary>
    public class ListTrashedDocuments : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTrashedDocuments Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTrashedDocuments(TembooSession session) : base(session, "/Library/Zoho/Writer/ListTrashedDocuments")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTrashedDocumentsResultSet containing execution metadata and results.</returns>
        new public ListTrashedDocumentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTrashedDocumentsResultSet results = new JavaScriptSerializer().Deserialize<ListTrashedDocumentsResultSet>(json);
    ...
    /// </summary>
    public class ListTrashedDocumentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
