...
namespace Temboo.Library.Zoho.Writer
{
    ...
    /// </summary>
    public class ListAllDocuments : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllDocuments Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllDocuments(TembooSession session) : base(session, "/Library/Zoho/Writer/ListAllDocuments")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllDocumentsResultSet containing execution metadata and results.</returns>
        new public ListAllDocumentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllDocumentsResultSet results = new JavaScriptSerializer().Deserialize<ListAllDocumentsResultSet>(json);
    ...
    /// </summary>
    public class ListAllDocumentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
