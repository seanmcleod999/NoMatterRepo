...
namespace Temboo.Library.Zoho.Writer
{
    ...
    /// </summary>
    public class ListSharedDocuments : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListSharedDocuments Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListSharedDocuments(TembooSession session) : base(session, "/Library/Zoho/Writer/ListSharedDocuments")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListSharedDocumentsResultSet containing execution metadata and results.</returns>
        new public ListSharedDocumentsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListSharedDocumentsResultSet results = new JavaScriptSerializer().Deserialize<ListSharedDocumentsResultSet>(json);
    ...
    /// </summary>
    public class ListSharedDocumentsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
