...
namespace Temboo.Library.Zoho.Sheet
{
    ...
    /// </summary>
    public class ListSharedSpreadsheets : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListSharedSpreadsheets Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListSharedSpreadsheets(TembooSession session) : base(session, "/Library/Zoho/Sheet/ListSharedSpreadsheets")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListSharedSpreadsheetsResultSet containing execution metadata and results.</returns>
        new public ListSharedSpreadsheetsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListSharedSpreadsheetsResultSet results = new JavaScriptSerializer().Deserialize<ListSharedSpreadsheetsResultSet>(json);
    ...
    /// </summary>
    public class ListSharedSpreadsheetsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
