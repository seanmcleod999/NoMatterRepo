...
namespace Temboo.Library.Zoho.Sheet
{
    ...
    /// </summary>
    public class ListAllSpreadsheets : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListAllSpreadsheets Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListAllSpreadsheets(TembooSession session) : base(session, "/Library/Zoho/Sheet/ListAllSpreadsheets")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListAllSpreadsheetsResultSet containing execution metadata and results.</returns>
        new public ListAllSpreadsheetsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListAllSpreadsheetsResultSet results = new JavaScriptSerializer().Deserialize<ListAllSpreadsheetsResultSet>(json);
    ...
    /// </summary>
    public class ListAllSpreadsheetsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
