...
namespace Temboo.Library.Zoho.Sheet
{
    ...
    /// </summary>
    public class ListTrashedSpreadsheets : Temboo.Core.Choreography
    {

        /// <summary>
        /// Create a new instance of the ListTrashedSpreadsheets Choreo
        /// </summary>
        /// <param name="session">A TembooSession object, containing a valid set of Temboo credentials.</param>
        public ListTrashedSpreadsheets(TembooSession session) : base(session, "/Library/Zoho/Sheet/ListTrashedSpreadsheets")
        {
        }
        ...
        /// </summary>
        /// <returns>A ListTrashedSpreadsheetsResultSet containing execution metadata and results.</returns>
        new public ListTrashedSpreadsheetsResultSet execute()
        {
            String json = base.getResponseJSON(false, true);
            ListTrashedSpreadsheetsResultSet results = new JavaScriptSerializer().Deserialize<ListTrashedSpreadsheetsResultSet>(json);
    ...
    /// </summary>
    public class ListTrashedSpreadsheetsResultSet : Temboo.Core.ResultSet
    {
        /// <summary> 
