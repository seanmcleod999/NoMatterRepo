...
namespace Temboo.Library.Kiva.JournalEntries
{
    ...
    public class GetComments : Temboo.Core.Choreography
    {
        ...
        public GetComments(TembooSession session) : base(session, "/Library/Kiva/JournalEntries/GetComments")
        {
        }
         ...
         /// </summary>
         /// <param name="value">Value of the JournalID input for this Choreo.</param>
         public void setJournalID(String value) {
             base.addInput ("JournalID", value);
         }
         /// <summary>
