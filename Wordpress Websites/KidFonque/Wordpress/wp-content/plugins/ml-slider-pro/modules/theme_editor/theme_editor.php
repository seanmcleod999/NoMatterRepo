...
class MetaSliderThemeEditor {
    ...
    public function register_theme_editor_menu() {
        $page = add_submenu_page( 'metaslider', __( 'Theme Editor', 'metasliderpro' ), __( 'Theme Editor', 'metasliderpro' ), 'manage_options', 'metaslider-theme-editor', array( $this, 'process_admin_page' ) );
